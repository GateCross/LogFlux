...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  security_binding: () => import("@/views/security/binding/index.vue"),
  security_crs: () => import("@/views/security/crs/index.vue"),
  security_exclusion: () => import("@/views/security/exclusion/index.vue"),
  security: () => import("@/views/security/index.vue"),
  security_job: () => import("@/views/security/job/index.vue"),
  security_observe: () => import("@/views/security/observe/index.vue"),
  security_ops: () => import("@/views/security/ops/index.vue"),
  security_policy: () => import("@/views/security/policy/index.vue"),
  security_release: () => import("@/views/security/release/index.vue"),
  security_runtime: () => import("@/views/security/runtime/index.vue"),
  security_source: () => import("@/views/security/source/index.vue"),
