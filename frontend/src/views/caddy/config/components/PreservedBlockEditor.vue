  ...
  <div>
    ...
    <div v-if="!editing" class="rounded-md bg-gray-50 p-3">
      <div class="mb-2 flex justify-end">
        <NButton size="tiny" text type="primary" @click="startEdit">
          <template #icon>
      ...
      <NCode :code="block.raw" language="shell" word-wrap />
    </div>
    ...
    <div v-else>
      ...
      <div class="mt-2 flex justify-end gap-2">
        ...
        <NButton size="tiny" type="primary" @click="confirmEdit">应用</NButton>
      </div>
    </div>
  </div>
</template>
