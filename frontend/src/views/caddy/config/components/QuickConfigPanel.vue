...
<template>
  <div class="h-full min-h-0 flex flex-col gap-4 overflow-hidden lg:flex-row">
    <NCard size="small" :bordered="false" class="quick-sidebar">
      <template #header>
    ...
    <div class="min-h-0 flex-1 overflow-auto pr-1">
      <NSpace vertical size="large">
        ...
        <NCard v-if="props.complexSites.length" size="small" :bordered="false">
          <template #header>
            <div class="flex items-center justify-between gap-3">
              <div>
          ...
          <div class="flex flex-col gap-3">
            ...
            >
              ...
              <div class="mt-2 flex flex-wrap gap-2">
                <NTag v-for="reason in site.reasons" :key="reason" size="small" type="warning" :bordered="false">
                  {{ reason }}
                </NTag>
              </div>
            </div>
