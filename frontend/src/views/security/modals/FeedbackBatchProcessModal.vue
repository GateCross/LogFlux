...
defineProps<{
  ...
  handleSubmitPolicyFeedbackBatchProcess: () => void;
}>();
...
<template>
  ...
  >
    <div class="mb-3 text-sm text-gray-600">已选择 {{ checkedRowKeys.length }} 条反馈记录</div>
    ...
    <template #footer>
      <div class="flex justify-end gap-2">
        ...
        <NButton type="warning" :loading="submitting" @click="handleSubmitPolicyFeedbackBatchProcess">批量保存</NButton>
      </div>
    </template>
  </NModal>
</template>
