  ...
  <div>
    ...
    <div class="mb-3 flex flex-wrap items-center gap-2">
      <NSelect
        ...
        class="w-240px"
      />
      <NSelect v-model:value="policyStatsQuery.window" :options="observeWindowOptions" class="w-180px" />
      <NInputNumber
      ...
      <NButton secondary :loading="policyFeedbackLoading" @click="fetchPolicyFalsePositiveFeedbacks">刷新反馈</NButton>
    ...
    <NCard :bordered="false" size="small" class="mt-3">
      <div class="mb-2 text-sm font-semibold">人工误报反馈（当前筛选口径）</div>
      <NDataTable
        remote
    ...
    <NGrid cols="3" x-gap="12" y-gap="12" class="mt-3">
      <NGi>
