const local: App.I18n.Schema = {
  ...
  route: {
    ...
    security_runtime: 'Runtime Mode',
    security_crs: 'CRS Tuning',
    security_exclusion: 'Rule Exclusions',
    security_binding: 'Policy Bindings',
    security_observe: 'Policy Observe',
    security_ops: 'Release & Jobs',
    security_release: 'Release Management',
    security_job: 'Task Logs',
