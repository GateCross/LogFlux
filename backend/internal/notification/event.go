...
const (
	...
	EventSecurityWafSourceCheckSuccess     = "security.waf_source_check_success"
	EventSecurityWafSourceCheckFailed      = "security.waf_source_check_failed"
	EventSecurityWafSourceSyncSuccess      = "security.waf_source_sync_success"
	EventSecurityWafSourceSyncFailed       = "security.waf_source_sync_failed"
	EventSecurityWafReleaseActivateSuccess = "security.waf_release_activate_success"
	EventSecurityWafReleaseActivateFailed  = "security.waf_release_activate_failed"
	EventSecurityWafReleaseRollbackSuccess = "security.waf_release_rollback_success"
	EventSecurityWafReleaseRollbackFailed  = "security.waf_release_rollback_failed"
)
