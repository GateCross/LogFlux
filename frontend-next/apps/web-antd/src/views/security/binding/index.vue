...
const modalTitle = ref('Create Binding');
...
function handleCreate() {
  ...
  modalTitle.value = 'Create Binding';
...
<template>
  <Page title="Policy Bindings" description="Bind WAF policies to server names and URL paths.">
    <Card>
      <template #extra>
        <Space>
          <Button type="primary" @click="handleCreate">Add Binding</Button>
